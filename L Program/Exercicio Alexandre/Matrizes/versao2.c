...
printf("\n\nTeste de confirmacao com sucesso do malloc na Matriz!\n");
...
void funcaoAloca(int x, int y, int z, int ***matrizXYZ){
    //Cada dimensão da matriz representados por X, Y, Z vai ser utilizado
    int i, j, k; //Variaveis auxiliares
   //Matriz que irá se alocar dinamicamente em 3 dimensões é a ***matrizXYZ
